...
description: Workflow to resolve PR or ticket review comments. Use when the user wants inbound review threads handled.
user-invocable: true
---

# Address review feedback

1. Collect open comments from the git-host MCP (and tracker if used for review).
